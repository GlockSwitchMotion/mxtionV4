...
local getcustomassets = {
	['mxtionv4/assets/wurst/triangle.png'] = 'rbxasset://wurst/triangle.png'
}
...
local function downloadFile(path, func)
	if not isfile(path) then
		local suc, res = pcall(function() return game:HttpGet('https://raw.githubusercontent.com/GlockSwitchMotion/mxtionV4/'..readfile('mxtionv4/profiles/commit.txt')..'/'..select(1, path:gsub('mxtionv4/', '')), true) end)
...
function mainapi:CreateCategory(categorysettings)
	...
	function categoryapi:CreateModule(modulesettings)
		...
		triangle.Image = getcustomasset('mxtionv4/assets/wurst/triangle.png')
...
for _, v in {'Combat', 'Blatant', 'Render', 'Utility', 'World', 'Inventory', 'Minigames', 'Kits'} do
