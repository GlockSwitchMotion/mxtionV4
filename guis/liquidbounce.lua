...
local getcustomassets = {
	['mxtionv4/assets/liquidbounce/blatant.png'] = 'rbxasset://liquidbounce/blatant.png',
	['mxtionv4/assets/liquidbounce/combat.png'] = 'rbxasset://liquidbounce/combat.png',
	['mxtionv4/assets/liquidbounce/expand.png'] = 'rbxasset://liquidbounce/expand.png',
	['mxtionv4/assets/liquidbounce/inventory.png'] = 'rbxasset://liquidbounce/inventory.png',
	['mxtionv4/assets/liquidbounce/logo.png'] = 'rbxasset://liquidbounce/logo.png',
	['mxtionv4/assets/liquidbounce/minigames.png'] = 'rbxasset://liquidbounce/minigames.png',
	['mxtionv4/assets/liquidbounce/render.png'] = 'rbxasset://liquidbounce/render.png',
	['mxtionv4/assets/liquidbounce/textgui.png'] = 'rbxasset://liquidbounce/textgui.png',
	['mxtionv4/assets/liquidbounce/utility.png'] = 'rbxasset://liquidbounce/utility.png',
	['mxtionv4/assets/liquidbounce/world.png'] = 'rbxasset://liquidbounce/world.png',
...
local function writeFont()
	...
	--[[writefile('mxtionv4/assets/liquidbounce/lbfont.json', httpService:JSONEncode({
		name = 'Inter',
		faces = {
			{style = 'normal', assetId = getcustomasset('mxtionv4/assets/liquidbounce/Inter-Light.ttf'), name = 'Light', weight = 300},
			{style = 'normal', assetId = getcustomasset('mxtionv4/assets/liquidbounce/Inter-Regular.ttf'), name = 'Regular', weight = 400},
			{style = 'normal', assetId = getcustomasset('mxtionv4/assets/liquidbounce/Inter-Medium.ttf'), name = 'Medium', weight = 500}
		}
	}))]]
	return getcustomasset('mxtionv4/assets/liquidbounce/lbfont.json')
end
...
components = {
	...
	Dropdown = function(optionsettings, children, api)
		...
		dropdownexpand.Image = getcustomasset('mxtionv4/assets/liquidbounce/expand.png')
...
function mainapi:CreateCategory(categorysettings)
	...
	function categoryapi:CreateModule(modulesettings)
		...
		expandicon.Image = getcustomasset('mxtionv4/assets/liquidbounce/expand.png')
...
mainapi:CreateCategory({
	Name = 'Combat',
	Icon = getcustomasset('mxtionv4/assets/liquidbounce/combat.png'),
	Size = UDim2.fromOffset(16, 15)
})
mainapi:CreateCategory({
	Name = 'Blatant',
	Icon = getcustomasset('mxtionv4/assets/liquidbounce/blatant.png'),
	Size = UDim2.fromOffset(15, 15)
})
mainapi:CreateCategory({
	Name = 'Render',
	Icon = getcustomasset('mxtionv4/assets/liquidbounce/render.png'),
	Size = UDim2.fromOffset(15, 9)
})
mainapi:CreateCategory({
	Name = 'Utility',
	Icon = getcustomasset('mxtionv4/assets/liquidbounce/utility.png'),
	Size = UDim2.fromOffset(15, 15)
})
mainapi:CreateCategory({
	Name = 'World',
	Icon = getcustomasset('mxtionv4/assets/liquidbounce/world.png'),
	Size = UDim2.fromOffset(15, 15)
})
mainapi:CreateCategory({
	Name = 'Inventory',
	Icon = getcustomasset('mxtionv4/assets/liquidbounce/inventory.png'),
