...
if not shared.vapereload then
	-- Must run synchronously so old cached files are cleared before loading
	handleUpdates()
end
...
if not shared.VapeIndependent then
	...
	task.defer(function()
		-- Download universal + game script in parallel
		local universalDone = false
		...
		-- Wait for both to finish before showing the menu
		repeat task.wait() until universalDone and gameDone
