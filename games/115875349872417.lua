...
local drawingactor = loadstring(downloadFile('mxtionv4/libraries/drawing.lua'), 'drawing')(...)
local redline = {Teams = {}}
...
local function warningRoutine(hash)
	local path = 'mxtionv4/profiles/agreementhash.txt'
...
if not select(1, ...) then
	if run_on_actor then
		...
		task.spawn(function()
			...
			local executionString = "loadfile('mxtionv4/main.lua')("..drawingactor..")"
