...
run(function()
    local ArmorTrimModule = vape.Categories.Minigames:CreateModule({
        Name = 'Armor Trims',
        Object = Instance.new('Folder'),
    })

    local ArmorTrimEffectType = {
        DEFAULT = 'default',
        FIRE_WARM = 'fire_warm',
        FIRE_COOL = 'fire_cold',
        FIRE_BLACK = 'fire_black',
        FIRE_PURPLE = 'fire_purple',
        FIRE_RED = 'fire_red',
        FROSTY = 'frosty',
        VOID = 'void',
        SPIRIT = 'spirit',
    ...
    local ArmorTrimNames = {
        ['default'] = 'Default',
        ['fire_warm'] = 'Fire',
        ['fire_cold'] = 'Ice Flame',
        ['fire_black'] = 'Black Flame',
        ['fire_purple'] = 'Void Flame',
        ['fire_red'] = 'Hellfire Flame',
        ['frosty'] = 'Frosty',
        ['void'] = 'Void',
        ['spirit'] = 'Spirit',
        ['bat'] = 'Bat',
    ...
    local TrimList = {}
    for key, value in pairs(ArmorTrimEffectType) do
    ...
    local ArmorTrimDropdown = ArmorTrimModule:CreateDropdown({
        ...
        Tooltip = 'Choose your armor trim effect'
    })

    ArmorTrimModule:CreateToggle({
        Name = 'Auto-Equip Trim',
        Default = false,
        Function = function(val)
            if val then
    ...
    getgenv().getSelectedArmorTrim = function()
        return store.selectedArmorTrim
    end
